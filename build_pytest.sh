...
ssh -i  /Users/ruhisehgal/.ssh/db2whmigratetocos-dev root@9.30.214.235 "cd /root/db2migrate/db2whmigratetocos-0.0.1 && python3 -m unittest /tests/get_connection_string_test.py"
ssh -i  /Users/ruhisehgal/.ssh/db2whmigratetocos-dev root@9.30.214.235 "cd /root/db2migrate/db2whmigratetocos-0.0.1 && python3 -m unittest /tests/get_schema_in_instance_test.py"
