...
ssh -i /Users/ruhisehgal/.ssh/db2whmigratetocos-dev root@9.30.214.235 "cd /root/db2migrate/db2whmigratetocos-0.0.1  && python -m unittest tests/test_adm_move_table_phase.py"