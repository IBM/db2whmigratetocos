...
class TestGetConnectionString(unittest.TestCase):
    def test_valid_inputs(self):
        ...
        conn_string = get_connection_string(vdata['Uid'], vdata['Pwd'], vdata['Hostname'], vdata['Port'], vdata['Database'])
    ...
    def test_invalid_inputs(self):
        raised = False
        try:
            actual_output = get_connection_string(data['invalid_inputs']['Uid'],data['valid_inputs']['Pwd'],data['valid_inputs']['Hostname'], data['valid_inputs']['Port'], data['invalid_inputs']['Database'])
